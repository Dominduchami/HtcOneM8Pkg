...
#define MSM8974_PERIPH_BASE              0xA0000000
#define MSM8974_PERIPH_SIZE              0x0C300000
...
ArmPlatformGetVirtualMemoryMap (
    ...
    VirtualMemoryTable[Index].PhysicalBase  = MSM8974_PERIPH_BASE;
    VirtualMemoryTable[Index].VirtualBase     = VirtualMemoryTable[Index].PhysicalBase;
    VirtualMemoryTable[Index].Length          = MSM8974_PERIPH_SIZE;
    VirtualMemoryTable[Index++].Attributes      = ARM_MEMORY_REGION_ATTRIBUTE_DEVICE;
